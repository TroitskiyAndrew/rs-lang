...
export default class PageHome extends BaseComponent {
  ...
  private renderFooter(page: HTMLDivElement) {
    const homeFooter = document.createElement('footer');
    const schoolLink = document.createElement('a');

    homeFooter.className = 'home-footer';
    schoolLink.className = 'home-footer__school-link';

    schoolLink.textContent = 'The Rolling Scopes';
    schoolLink.href = 'https://rs.school/';

    homeFooter.innerHTML = '2022&nbsp;&nbsp;&nbsp;'
    homeFooter.append(schoolLink);
    page.append(homeFooter);
  }
